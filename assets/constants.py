__all__: tuple[str] = ("PROJECT", "DATABASE", "CRUISE_SPEED", "LAND_SPEED",
                       "EARTH_EQUATORIAL_RADIUS", "EARTH_MEAN_RADIUS", "EARTH_POLAR_RADIUS",
                       "MAX_DEGREE_LAT", "MAX_DEGREE_LONG", "MAX_MINUTE")
